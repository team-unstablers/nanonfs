...
enum NFSStatus: UInt32 {
    ...
    case badxdr            = 10036
    case locksHeld         = 10037   // NFS4ERR_LOCKS_HELD     (RFC 7530 §13.1.8.6)
    case openMode          = 10038   // NFS4ERR_OPENMODE       (RFC 7530 §13.1.8.9)
    case badowner          = 10039   // NFS4ERR_BADOWNER       (RFC 7530 §13.1.11.2)
    case badchar           = 10040   // NFS4ERR_BADCHAR        (RFC 7530 §13.1.7.1)
    case badname           = 10041   // NFS4ERR_BADNAME        (RFC 7530 §13.1.7.2)
    case badRange          = 10042   // NFS4ERR_BAD_RANGE      (RFC 7530 §13.1.8.1)
    case lockNotSupp       = 10043   // NFS4ERR_LOCK_NOTSUPP   (RFC 7530 §13.1.8.7)
